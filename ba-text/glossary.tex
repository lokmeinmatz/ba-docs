...
\newglossaryentry{brownfield}{
  ...
  description={Brownfield development is the opposite of greenfield development, brownfield refers to adding ''new capabilities on an existing product or product platform, using existing technology'' \cite{BrownfieldToGreenfield:2021ys}.}
}
