...
\begin{description}
  ...
  \begin{description}[nosep]
    \item[Heavy configuration -] Internal developers used the tools to build new apps and websites from scratch, making a wide range of modifications and structural changes.
    ...
    \item[Small changes -] External customers often only use the tools to exchange ads, translations or logos, which affects a small set of files.
  \end{description}
  \item[Expertise] -
  \begin{description}[nosep]
...
Some of the outcomes from the user interviews will be further discussed in chapter \ref*{chap:impl}.
