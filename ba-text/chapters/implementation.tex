...
Test-driven development (TDD), where the tests are written upfront based on specifications and constraints with invariants, pre- and postconditions, are also made possible with unit tests.
\\
